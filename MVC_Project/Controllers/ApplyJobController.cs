...
namespace MVC_Project.Controllers
{
    public class ApplyJobController : Controller
    {
        ...
        public ActionResult ApplyJob_Load(int cid, int jid)
        {
            ...
            dbobj.sp_checkApplyExist(jid, Convert.ToInt32(Session["uid"]), op);
        ...
        public ActionResult ApplyJob_Click(ApplyJobs clsobj, DisplayAllnSearch obj, HttpPostedFileBase file)
        {
